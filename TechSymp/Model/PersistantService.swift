...
class PersistantService {
    ...
    static func savePage(eventobj: Event){
        
        let itemToSave: Events = NSEntityDescription.insertNewObject(forEntityName: "Events", into: context) as! Events
        
        itemToSave.eventname = eventobj.eventname
        itemToSave.expectation = eventobj.expectation
        itemToSave.overview =  eventobj.overview
    ...
    static func getSavedPageList()->[Events] {
        
        let fetchRequest = NSFetchRequest<Events>(entityName: "Events")
        var wikipageArray = [Events]()
    ...
    static func deleteAllEntries() {
        let deleteFetch = NSFetchRequest<NSFetchRequestResult>(entityName: "Events")
    ...
    static var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "TechSymp")
